...
const uniqueNumbers = numbers2.filter((value, index, self) => self.indexOf(value) === index);
...
// searchElement - A keresett elem, amelynek az indexét szeretném megtalálni
// fromIndex - (opcisonális) Az index, ahonnan kezdődik a keresés. Alapértelemezetten 0
...
const index2 = numbers.indexOf(60);
