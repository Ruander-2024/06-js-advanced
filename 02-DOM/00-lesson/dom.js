...
console.log(buttonClassElements.namedItem('rome-btn')); // A kiválasztott gombon belüli rome-btn-el ellátott gomb
...
// ATTRIBUTES
buttonClassElements.namedItem('rome-btn').style.color = 'red';

buttonClassElements.namedItem('rome-btn').style.backgroundColor = 'blue';
