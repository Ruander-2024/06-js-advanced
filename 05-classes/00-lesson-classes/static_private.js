class Dog{
    #sex; // private, nem tudjuk átírni és rejtve marad
    ...
    get sex(){
        return this.#sex; // Getter nélkül a private értéke rejtve marad undefined értéket kapunk
    }
...
console.log(dog1.logClassName); // A static-ot a class-on kívül nem éred el
