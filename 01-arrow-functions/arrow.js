...
// kisebb számot. Majd adja vissza a különbségüket.
    const differenceOfNumber = (num1, num2) =>      // num1 > num2 ? (ha igaz) num1 - num2 : (ha hamis) num2 - num1; 
...
// összefonva egy stringként. (Pl: 'Tom', 'Tailor', 1980   => Output 'Tom Tailor 1980')
 ...
 console.log(joinData('Tom', 'Tailor', 1980)); //  Output: 'Tom Tailor 1980'      összefűzés Template Literallal ` ${ide jön a szöveg}  `
...
//hogy a tömb tartalmazza e a számot? Ha igen adjon vissza true, ha nem akkor false-t.
    const chekArrayIncludeNumber = (num1, arr) => arr.includes(num1);
