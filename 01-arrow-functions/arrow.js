...
const differenceOfNumber = (a, b) => Math.abs(a - b);
...
const checkArrayIncludeNumber = (num, arr) => arr.includes(num);
 console.log(checkArrayIncludeNumber(23, [4, 5, 66, 7, 8])); // Output: false
 console.log(checkArrayIncludeNumber(23, [5, 6, 77, 8, 23, 5])); //  Output: true;
