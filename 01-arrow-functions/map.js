...
const doubledNumbers = numbers.map(function(number){ // szám duplázása
    return number * 2;
})

const doubledNumbers2 = numbers.map(number => numbers * 2); // Arrow function
...
const updatedProducts = products.map(product => {
    return{
        ...
        discountedPrice: product.price * 0.9 // 10% kedvezmény        kedvezményes ár
    };
});
